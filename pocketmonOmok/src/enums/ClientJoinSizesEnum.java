...
public enum ClientJoinSizesEnum {
	...
	JOIN_ID_POSITION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.07)), //옆위치
	JOIN_ID_POSITION_Y((int)(JOINFRMAE_SIZE_HEIGHT.getSize() * 0.08)), //아래 위치
	
	
	JOIN_PWD_POSITION_X(JOIN_ID_POSITION_X.getSize()),
	JOIN_PWD_POSITION_Y(JOIN_ID_POSITION_Y.getSize() * 2), // JOIN_ID_POSITION_Y.getSize() * 2 -- >아이디레이블 위치 잡고 그 위치에 따라 * 2씩 함
	
	JOIN_REPWD_POSITION_X(JOIN_ID_POSITION_X.getSize()),
	JOIN_REPWD_POSITION_Y(JOIN_ID_POSITION_Y.getSize() * 3),
	
	JOIN_NAME_POSITION_X(JOIN_ID_POSITION_X.getSize()),
	JOIN_NAME_POSITION_Y(JOIN_ID_POSITION_Y.getSize() * 4),
	
	JOIN_GENDER_POSITTION_X(JOIN_ID_POSITION_X.getSize()),
	JOIN_GENDER_POSITTION_Y(JOIN_ID_POSITION_Y.getSize() * 5),
	
	JOIN_BIRTH_POSITTION_X(JOIN_ID_POSITION_X.getSize()),
	JOIN_BIRTH_POSITTION_Y(JOIN_ID_POSITION_Y.getSize() * 6),
	
	JOIN_YEAR_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.46)),
	JOIN_YEAR_POSITTION_Y((int)(JOINFRMAE_SIZE_HEIGHT.getSize() * 0.483)),
	
	JOIN_MONTH_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.68)),
	JOIN_MONTH_POSITTION_Y((int)(JOINFRMAE_SIZE_HEIGHT.getSize() * 0.483)),
	
	JOIN_DATE_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.9)),
	JOIN_DATE_POSITTION_Y((int)(JOINFRMAE_SIZE_HEIGHT.getSize() * 0.483)),
	
	JOIN_EMAIL_POSITTION_X(JOIN_ID_POSITION_X.getSize()),
	JOIN_EMAIL_POSITTION_Y(JOIN_ID_POSITION_Y.getSize() * 7),
	
	JOIN_TEL_POSITTION_X(JOIN_ID_POSITION_X.getSize()),
	JOIN_TEL_POSITTION_Y(JOIN_ID_POSITION_Y.getSize() * 9),
...
//텍스트필드  위치 조절-------------------------------------------
	...
	JOIN_AT_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.46)),
	JOIN_AT_POSITTION_Y(JOIN_EMAILT_POSITTION_Y.getSize()),
	
	JOIN_EMAILADRT_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.52)),
	JOIN_EMAILADRT_POSITTION_Y(JOIN_EMAILT_POSITTION_Y.getSize()),

	JOIN_CONFIRMT_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.5)),
	JOIN_CONFIRMT_POSITTION_Y((int)(JOINFRMAE_SIZE_HEIGHT.getSize() * 0.6)),
	
	JOIN_TELT_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.53)),
	...
	JOIN_HYPHEN1_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.48)),
	JOIN_HYPHEN1_POSITTION_Y(JOIN_TELT_POSITTION_Y.getSize()),
	
	JOIN_HYPHEN2_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.65)),
	...
	JOIN_EMAILCHOICE_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.72)),
	JOIN_EMAILCHOICE_POSITTION_Y(JOIN_YEARCHOICE_POSITTION_Y.getSize()),
	...
	JOIN_JOIN_POSITTION_X((int)(JOINFRAME_SIZE_WIDTH.getSize() * 0.60)),
